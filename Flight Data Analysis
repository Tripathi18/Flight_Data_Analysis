...
**Visualizations:** This section creates various visualizations to understand different aspects of flight data. It includes pie charts, bar plots, box plots, scatter plots, line graphs, and heat maps.
...
**Performance Analysis:** This section analyzes carrier performance by calculating average monthly departure delays, average monthly departure delays by the carrier, average arrival delays by the carrier, and monthly trends in arrival delays.
